...
class Search():
    ...
    def conduct_search(self, area_num, area_array, effectiveness_prob):
        ...
        # generate a list of coordinates and then shuffle them & then multiply by effectiveness_prob
        coords = list(itertools.product(local_x_range, local_y_range))
        random.shuffle(coords)
        coords = coords[:int((len(coords) * effectiveness_prob))]
        # assign the sailor's actual location
    ...
    def revise_target_probs(self):
        """Update area target possibilities based on search effectiveness"""
...
def main():
    ...
    while True:
        ...
        app.revise_target_probs() # use Bayes's rule to update target probabilities
